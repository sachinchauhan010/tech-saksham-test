...
export default function LiveQuestionCard({
	...
	return (
		<Card className={className ?? 'transition-shadow hover:shadow-md w-full px-4 m-0'}>
			<div className="flex w-full items-center justify-between gap-2">
				<div className="flex-1 min-w-0">
					<p className="break-words text-foreground text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-base">
						{index !== undefined && (
							<span className="mr-1">
								{index + 1}.
							</span>
