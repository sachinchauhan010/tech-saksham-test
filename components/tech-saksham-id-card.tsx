  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-10 pointer-events-none flex flex-col items-center justify-center ">
        ...
        <div
          className="absolute left-1/2 -translate-x-1/2 bottom-[77px] flex items-center justify-center w-[76px] h-[76px] rounded-[10px] bg-white shadow-[0_6px_18px_rgba(30,46,122,0.12)] pointer-events-auto"
