...
export default function LiveQuestionsPage() {
	...
	const fetchQuestions = async (showLoader = true) => {
		...
		try {
			const response = await apiClient.get('/api/delegate/live-questions');
	...
	return (
		<ComponentWrapper>
		<section className="rounded-2xl border border-blue-100 bg-white p-4 shadow-sm sm:p-6 w-full mx-auto">
			<div className="mb-6">
