...
export default function CreateAdmin() {
  ...
  const onSubmit = async (data: CreateAdminFormData) => {
    ...
    try {
      ...
      const responseData = await apiClient.post('/api/admin/manage-admin', {...data});
      
      if (responseData.data.success) {
        toast.success('Admin user created successfully');
        router.push('/admin/manage-admin');
      } else {
        toast.error(responseData.data.error || 'Failed to create admin');
      }
    } catch (error) {
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">Only Super Admins can create admin users.</p>
          <Button 
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Add a new administrator to manage your platform</p>
          </div>
        </div>
